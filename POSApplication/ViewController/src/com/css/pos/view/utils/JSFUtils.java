...
public class JSFUtils {
   ...
   */
    ...
    public static String getMessageFromBundle(String key) {
        //ResourceBundle bundle = getBundle();
        //
        oracle.javatools.resourcebundle.ChainedKeyValueMap bundle =
            (oracle.javatools.resourcebundle.ChainedKeyValueMap)resolveExpression("#{adfBundle['com.oracle.hr.view.ViewControllerBundle']}");
